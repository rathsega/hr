...
<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="nav-links-li @if ($current_route == 'admin.billabletimesheet') showMenu @endif">
            <div class="iocn-link">
                <a class="w-100" href="{{ route('admin.billabletimesheet') }}">
                    <div class="sidebar_icon">
                        <svg id="fi_7691413" height="48" viewBox="0 0 32 32" width="48" xmlns="http://www.w3.org/2000/svg">
                            <g id="calendar">
                                <path d="m30 6.93v4.07h-28v-4.07a2.9688 2.9688 0 0 1 3-2.93h2v2a3 3 0 0 0 6 0v-2h6v2a3 3 0 0 0 6 0v-2h2a2.9688 2.9688 0 0 1 3 2.93z">
  ...
  <path d="M2 13c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"/>
        ...
        <li class="nav-links-li dropdownToggle @if (
            $current_route == 'admin.payrollconfiguration' ||
                $current_route == 'admin.payrollconfiguration.advances' ||
                $current_route == 'admin.payrollconfiguration.allowances') active showMenu @endif">
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
                    ...
                    <span class="link_name">{{ get_phrase('Config Payroll') }}</span>
                </a>
                <span class="arrow">
                    <svg xmlns="http://www.w3.org/2000/svg" width="4.743" height="7.773" viewBox="0 0 4.743 7.773">
                        <path id="navigate_before_FILL0_wght600_GRAD0_opsz24"
        ...
        <li class="nav-links-li dropdownToggle @if (
            ...
            <div class="iocn-link">
                <a href="#">
                    <div class="sidebar_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-file-earmark-spreadsheet-fill" viewBox="0 0 16 16">
  ...
  <path d="M9.293 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.707A1 1 0 0 0 13.707 4L10 .293A1 1 0 0 0 9.293 0M9.5 3.5v-2l3 3h-2a1 1 0 0 1-1-1M3 9h10v1h-3v2h3v1h-3v2H9v-2H6v2H5v-2H3v-1h2v-2H3z"/>
            ...
            <ul class="sub-menu">
                ...
                <li><a class="@if ($current_route == 'admin.reports.latelogin') active @endif" href="{{ route('admin.reports.latelogin') }}">{{ get_phrase('Late Logins') }}</a></li>
