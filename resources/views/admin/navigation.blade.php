        ...
        <li class="nav-links-li @if ($current_route == 'admin.payslip') showMenu @endif">
            <div class="iocn-link">
                <a class="w-100" href="{{ route('admin.payslip') }}">
                    <div class="sidebar_icon">
                        <svg height="48" width="48" version="1.1" id="fi_726182" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
