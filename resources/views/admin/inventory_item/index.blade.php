...
@section('content')
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
            <div class="d-flex flex-column">
                ...
                <ul class="d-flex align-items-center eBreadcrumb-2">
                    ...
                    <li><a href="{{ route('admin.inventory') }}">{{ get_phrase('Inventory') }}</a></li>
                    <li><a href="#">
                        @if($inventory)
                            {{ $inventory->title }}
                        @else
    ...
    <div class="eSection-wrap pb-4">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.inventory.item') }}" method="get">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            @foreach ($query->get() as $key => $inventory_item)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#"
                                            onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.inventory_item.edit', 'id' => $inventory_item->id]) }}', '{{ get_phrase('Edit inventory item') }}')"
                                            class="btn btn p-0 px-1" title="{{ get_phrase('Edit') }}" data-bs-toggle="tooltip">
                                            <i class="fi-rr-pencil"></i>
                                        </a>

                                        <a href="#" onclick="confirmModal('{{ route('admin.inventory.item.delete', $inventory_item->id) }}')" class="btn btn p-0 px-1"
