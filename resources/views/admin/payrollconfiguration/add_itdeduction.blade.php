...
@endphp
<h4 class="column-title">{{ get_phrase('Add IT Deduction') }}</h4>
    <form action="{{ route('admin.payrollconfiguration.add_itdeduction') }}" method="post" class="current-location-form">
        @Csrf
        <div class="row">
            <div class="col-md-12">
