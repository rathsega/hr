@extends('index')
@push('title', get_phrase('Employer Quotes'))
@push('meta')
@endpush
@push('css')
@endpush
...
<div class="mainSection-title">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        <div class="d-flex flex-column">
            <h4>{{ get_phrase('Employer Quotes') }}</h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
                <li><a href="#">{{ get_phrase('Dashboard') }}</a></li>
                <li><a href="#">{{ get_phrase('Employer Quotes') }}</a></li>
            </ul>
        </div>
        <div class="export-btn-area d-flex ">
            <a href="#" class="export_btn" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.quotes.add']) }}', '{{ __('Add Employer Quotes') }}')">
                <i class="bi bi-plus me-2"></i>
                <span class="d-none d-sm-inline-block">{{ get_phrase('Add Employer Quotes') }}</span>
            </a>
...
<div class="row">
    <div class="col-md-12">
        <div class="eSection-wrap">
            <p class="column-title mb-2">{{get_phrase('Employer Quotes')}}</p>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="confirmModal('{{ route('admin.quotes.delete', $quote->id) }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Delete') }}" data-bs-toggle="tooltip">
