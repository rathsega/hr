    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="fpb-7">
                ...
                <textarea type="quote" name="quote" class="form-control eForm-control" id="add_quote" required rows="6"  maxlength="150"></textarea>
...
<script>
    ...
    var textarea = document.getElementById("add_quote");
