...
<div class="eSection-wrap">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.payslip.update', $payslip->id) }}" method="post" enctype="multipart/form-data">
                @Csrf
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="fpb-7">
                            ...
                            @if($payslip->attachment)<a href="#" onclick="confirmModal('{{ route('admin.payslip.deleteAttachment', ['id' => $payslip->value('id'), 'attachment'=> $payslip->attachment]) }}')"
