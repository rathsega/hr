@extends('index')
@push('title', get_phrase('Attendance Report'))
@push('meta')
@endpush
@push('css')
@endpush
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
            <div class="d-flex flex-column">
                ...
                <ul class="d-flex align-items-center eBreadcrumb-2">
                    ...
                    <li><a href="#">{{ get_phrase('Attendance Report') }}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8 order-md-1">
            <div class="eSection-wrap">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('admin.attendance.reports') }}" method="post" id="filterForm">
                        @csrf
                            <div class="row mb-4">
                                <div class="col-md-4">
