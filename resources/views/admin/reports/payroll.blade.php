@extends('index')
@push('title', get_phrase('Payroll Report'))
@push('meta')
@endpush
@push('css')
@endpush
...
<div class="mainSection-title">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        <div class="d-flex flex-column">
            <h4>{{ get_phrase('Payroll Report') }}</h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
                <li><a href="{{ route('admin.dashboard') }}">{{ get_phrase('Dashboard') }}</a></li>
                <li><a href="#">{{ get_phrase('Payroll Report') }}</a></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="col-md-8 order-md-1">
        <div class="eSection-wrap">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="{{ route('admin.payrollconfiguration.download_report') }}" method="post" id="filterForm">
                        @csrf
                        <div class="row mb-4">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="fpb-7">
                                    <button class="btn-form mt-4">{{ get_phrase('Download Report') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
