@extends('index')
@push('title', get_phrase('Exit Report'))
@push('meta')
@endpush
@push('css')
@endpush
        ...
        <div class="col-md-8 order-md-1">
            <div class="eSection-wrap">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('admin.staff.exitreports') }}" method="post" id="filterForm">
                        @csrf
                            <div class="row mb-4">
                                <div class="col-md-4">
