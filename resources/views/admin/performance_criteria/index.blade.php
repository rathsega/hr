    ...
    <div class="mainSection-title">
        <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
            ...
            <div class="export-btn-area d-flex">
                <a href="#" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.performance_criteria.add']) }}', '{{ get_phrase('Add new criteria') }}')"
                    class="export_btn">
                            ...
                            @foreach (App\Models\Performance_type::get() as $performance_type)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#"
                                            onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.performance_criteria.edit', 'id' => $performance_type->id]) }}', '{{ get_phrase('Add new criteria') }}')"
                                            class="btn btn p-0 px-1" title="{{ get_phrase('Edit Criteria') }}" data-bs-toggle="tooltip">
                                            <i class="fi-rr-blog-pencil"></i>
                                        </a>

                                        <a href="#" onclick="confirmModal('{{ route('admin.performance.criteria.delete', ['id' => $performance_type->id]) }}')"
