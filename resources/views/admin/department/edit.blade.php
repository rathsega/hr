...
<form action="{{ route('admin.department.update', $department->id) }}" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="text" value="{{$department->title}}" name="title" class="form-control eForm-control" id="title" />
        </div>
        ...
        <div class="col-md-12 mt-3">
            ...
            <textarea name="description" class="form-control eForm-control" rows="2">{{$department->description}}</textarea>
        </div>
