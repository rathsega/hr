...
<div class="mainSection-title">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        ...
        <div class="export-btn-area d-flex ">
            <a href="#" class="export_btn" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.announcements.add']) }}', '{{ __('Add announcement') }}')">
                <i class="bi bi-plus me-2"></i>
                <span class="d-none d-sm-inline-block">{{ get_phrase('Add announcement') }}</span>
            </a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="confirmModal('{{ route('admin.announcements.delete', $announcement->id) }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Delete') }}" data-bs-toggle="tooltip">
