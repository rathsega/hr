		...
		<div class="card-body">
			<ul class="nav nav-tabs eNav-Tabs-custom" id="pills-tab" role="tablist">
				...
				<li class="nav-item ms-auto" role="presentation">
					<a href="#" data-bs-toggle="tooltip" data-bs-placement="top" class="btn btn-primary btn-sm"> <i class="bi bi-plus"></i> <span class="d-none d-sm-inline-block" onclick="showRightModal('{{route('right_modal', ['view_path'=>'admin.staff.add'])}}', '{{__('Add staff')}}')">Add new staff</span></a>

					<a href="#" data-bs-toggle="tooltip" data-bs-placement="top" class="btn btn-primary btn-sm ms-1" onclick="showRightModal('{{route('right_modal', ['view_path'=>'admin.staff.sorting'])}}', '{{__('Sort by drag and drop')}}')"> <i class="bi bi-sort-up"></i> <span class="d-none d-sm-inline-block">Sort</span></a>
				</li>
			</ul>
									...
									<td class="text-center">
										<div class="btn-group">
											...
											<ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
												<li>
													<a class="dropdown-item" onclick="showRightModal('{{route('right_modal', ['view_path'=>'admin.staff.edit', 'user_id' => $active_staff->id])}}', '{{__('Edit staff')}}')" href="#">Edit</a>
												</li>
												<li>
