...
@endphp
<h4 class="column-title">{{ get_phrase('Update Employee Of The Month') }}</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="fpb-7">
                    ...
                    <input type="checkbox" name="visibility" @if($eotm_details->visibility == 1) checked @endif id="visibility">
                </div>
            </div>
            <div class="col-md-12">
