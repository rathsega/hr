...
<div class="mainSection-title">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        ...
        <div class="export-btn-area d-flex ">
            <a href="#" class="export_btn" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.awards.eotm.add']) }}', '{{ __('Add Employee Of The Month') }}')">
                ...
                <table class="table eTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $eotm->visibility ? 'Visible' : 'Hidden' }}
                            </td>
                            <td>
                                <a href="#" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.awards.eotm.edit', 'eotm_id' => $eotm->id]) }}', '{{ __('Edit Employee Of The Month') }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Edit') }}" data-bs-toggle="tooltip">
