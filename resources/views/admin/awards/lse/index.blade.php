@extends('index')
@push('title', get_phrase('Long Service Employee'))
@push('meta')
@endpush
@push('css')
@endpush
...
<div class="mainSection-title">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        <div class="d-flex flex-column">
            <h4>{{ get_phrase('Long Service Employee') }}</h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
                <li><a href="#">{{ get_phrase('Dashboard') }}</a></li>
                <li><a href="#">{{ get_phrase('Long Service Employee') }}</a></li>
            </ul>
        </div>
        <div class="export-btn-area d-flex ">
            <a href="#" class="export_btn" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.awards.lse.add']) }}', '{{ __('Add Long Service Employee') }}')">
                <i class="bi bi-plus me-2"></i>
                <span class="d-none d-sm-inline-block">{{ get_phrase('Add Long Service Employee') }}</span>
            </a>
...
<div class="row">
    <div class="col-md-12">
        <div class="eSection-wrap">
            <p class="column-title mb-2">{{get_phrase('Long Service Employee')}}</p>
                ...
                <table class="table eTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $lse->visibility ? 'Visible' : 'Hidden' }}
                            </td>
                            <td>
                                <a href="#" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'admin.awards.lse.edit', 'lse_id' => $lse->id]) }}', '{{ __('Edit Long Service Employee') }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Edit') }}" data-bs-toggle="tooltip">
                                ...
                                <a href="#" onclick="confirmModal('{{ route('admin.lse.delete', $lse->id) }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Delete') }}" data-bs-toggle="tooltip">
