    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="fpb-7">
                ...
                <input type="datetime-local" value="{{ date('Y-m-d H:i') }}"  max="<?php echo date('Y-m-d\TH:i:s'); ?>" name="from_date" class="form-control eForm-control" id="fromDate" />
            </div>
        </div>
        <div class="col-md-12">
            <div class="fpb-7">
                <label for="toDate" class="eForm-label">{{get_phrase('To')}}</label>
                <input type="datetime-local" value="{{ date('Y-m-d H:i') }}" max="<?php echo date('Y-m-d\TH:i:s'); ?>" class="form-control eForm-control" name="to_date" id="toDate" />
            </div>
        </div>
        <div class="col-md-12">
            <div class="fpb-7">
