                ...
                <div class="user-details-info mw-unset">
                    ...
                    <ul class="nav nav-tabs eNav-Tabs-custom" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('admin.my.profile', ['info']) }}');" class="nav-link @if ($tab == 'info') active @endif"
                                type="button">
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('admin.my.profile', ['inventory']) }}');"
                    ...
                    <div class="tab-content eNav-Tabs-content" id="myTabContent">
                        <div class="tab-pane fade show active">
                            <div class="eForm-layouts">
                                @include('admin.my_profile.profile_' . $tab)
                            </div>
                        </div>
                    </div>
                </div>
