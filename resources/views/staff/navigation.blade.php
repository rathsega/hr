...
<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        @if (auth()->user()->billingtype == 'non-billable')
        ...
        @endif
        @if (auth()->user()->billingtype == 'billable')
        <li class="nav-links-li @if ($current_route == 'staff.billabletimesheet') showMenu @endif">
            <div class="iocn-link">
                <a class="w-100" href="{{ route('staff.billabletimesheet') }}">
                    <div class="sidebar_icon">
                        <svg id="fi_7691413" height="48" viewBox="0 0 32 32" width="48" xmlns="http://www.w3.org/2000/svg">
                            <g id="calendar">
                                <path d="m30 6.93v4.07h-28v-4.07a2.9688 2.9688 0 0 1 3-2.93h2v2a3 3 0 0 0 6 0v-2h6v2a3 3 0 0 0 6 0v-2h2a2.9688 2.9688 0 0 1 3 2.93z">
  ...
  <path fill-rule="evenodd" d="M6 3.5A1.5 1.5 0 0 1 7.5 2h1A1.5 1.5 0 0 1 10 3.5v1A1.5 1.5 0 0 1 8.5 6v1H14a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-1 0V8h-5v.5a.5.5 0 0 1-1 0V8h-5v.5a.5.5 0 0 1-1 0v-1A.5.5 0 0 1 2 7h5.5V6A1.5 1.5 0 0 1 6 4.5zm-6 8A1.5 1.5 0 0 1 1.5 10h1A1.5 1.5 0 0 1 4 11.5v1A1.5 1.5 0 0 1 2.5 14h-1A1.5 1.5 0 0 1 0 12.5zm6 0A1.5 1.5 0 0 1 7.5 10h1a1.5 1.5 0 0 1 1.5 1.5v1A1.5 1.5 0 0 1 8.5 14h-1A1.5 1.5 0 0 1 6 12.5zm6 0a1.5 1.5 0 0 1 1.5-1.5h1a1.5 1.5 0 0 1 1.5 1.5v1a1.5 1.5 0 0 1-1.5 1.5h-1a1.5 1.5 0 0 1-1.5-1.5z"/>
        ...
        <li class="nav-links-li @if ($current_route == 'staff.announcements') showMenu @endif">
            <div class="iocn-link">
                <a class="w-100" href="{{ route('staff.announcements') }}">
                    <div class="sidebar_icon">
