...
<div class="mainSection-title">
    <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
        ...
        <div class="export-btn-area">
            <a href="#" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'staff.billabletimesheet.add']) }}', '{{ get_phrase('Add new timesheet') }}')" class="export_btn">
                <i class="bi bi-plus"></i>
                <span class="d-none d-sm-inline-block">{{ get_phrase('Add new timesheet') }}</span>
            </a>
        </div>
    </div>
</div>
        ...
        <div class="eSection-wrap">
            ...
            <div class="table-responsive">
                <table class="table eTable">
                    ...
                    <tbody>
                        @foreach (App\Models\Billable_timesheets::orderBy('id')->get() as $key => $timesheet)
                        <tr>
                            <td>
                                {{ ++$key }}
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="#" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'staff.billabletimesheet.edit', 'id' => $timesheet->id]) }}', '{{ get_phrase('Edit timesheet') }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Edit') }}" data-bs-toggle="tooltip">
                                    <i class="fi-rr-pencil"></i>
                                </a>

                                <a href="#" onclick="confirmModal('{{ route('staff.billabletimesheet.delete', $timesheet->id) }}')" class="btn btn p-0 px-1" title="{{ get_phrase('Delete') }}" data-bs-toggle="tooltip">
