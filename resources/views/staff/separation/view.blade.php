                        ...
                        <div id="msform">
                            ...
                            <fieldset id="fieldset1" style="display: none;">
                                ...
                                <form action="{{route('staff.separation.manager_approvals')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fpb-7">
                                        <label for="reason" class="eForm-label">{{get_phrase('Comments')}}</label>
                                        <textarea type="text" name="reason" class="form-control eForm-control" id="reason" {{auth()->user()->id == $separation[0]->manager? '' : 'disabled'}}>{{$separation[0]->reporting_manager_comments}}</textarea>
                                    </div>
                                ...
                                <form action="{{route('staff.separation.hr_manager_approvals')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex flex-row">
                                        <div class="fpb-7 w-50">
                                            ...
                                            <input type="date" class="form-control eForm-control" name="hr_proposed_last_working_day" disabled value="{{ date('d, F, Y', strtotime($separation[0]->hr_proposed_last_working_day)) }}" />
                                        </div>
                                    ...
                                    <div class="fpb-7">
                                        <label for="reason" class="eForm-label">{{get_phrase('Comments')}}</label>
                                        <textarea type="text" name="reason" class="form-control eForm-control" id="reason" {{auth()->user()->email == 'accounts@zettamine.com'? '' : 'disabled'}}>{{$separation[0]->hr_manager_comments}}</textarea>
                                    </div>
                            ...
                            <fieldset id="fieldset3" style="display: none;">
                                ...
                                <form action="{{route('staff.separation.it_manager_approvals')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fpb-7">
                                        <label for="reason" class="eForm-label">{{get_phrase('Comments')}}</label>
                                        <textarea type="text" name="reason" class="form-control eForm-control" id="reason" {{auth()->user()->email == 'it@zettamine.com'? '' : 'disabled'}}>{{$separation[0]->it_manager_comments}}</textarea>
                                    </div>
                            ...
                            <fieldset id="fieldset4" style="display: none;">
                                ...
                                <form action="{{route('staff.separation.finance_manager_approvals')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fpb-7">
                                        <label for="reason" class="eForm-label">{{get_phrase('Comments')}}</label>
                                        <textarea type="text" name="reason" class="form-control eForm-control" id="reason" {{auth()->user()->email == 'accounts@zettamine.com'? '' : 'disabled'}}>{{$separation[0]->finance_manager_comments}}</textarea>
                                    </div>
