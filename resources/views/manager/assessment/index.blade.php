        ...
        <div class="col-md-8">
            <div class="eSection-wrap">
                <div class="row">
                    ...
                    @endphp
                    <div class="col-md-12">
                        <form action="{{ route('manager.assessment') }}" method="get" id="filterForm">
                            <div class="row mb-4">
                                <div class="col-md-6">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="p-0 ">
                                                                        <div class="invisible-layout">
                                                                            <a href="{{ route('manager.assessment', ['id' => $incident->id]) }}" class="btn btn p-1"
                                                                            ...
                                                                            <a href="#" onclick="confirmModal('{{ route('manager.assessment.delete', $incident->id) }}')"
                ...
                <div class="row">
                    <div class="col-md-12">
                        @if (isset($_GET['id']) && $_GET['id'] > 0)
                            @include('manager.assessment.edit')
                        @else
                            @include('manager.assessment.add')
                        @endif
                    </div>
                </div>
            </div>
