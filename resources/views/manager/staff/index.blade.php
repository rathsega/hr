                            ...
                            @foreach ($active_staffs as $active_staff)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('manager.staff.profile', ['info', $active_staff->id]) }}" class="btn btn p-0 px-1" title="View profile info"
                                        ...
                                        <a class="btn btn p-0 px-1"
                                            onclick="confirmModal('{{ route('manager.staff.status', ['status' => 'inactive', 'user_id' => $active_staff->id]) }}')" href="#"
                                        ...
                                        <a href="#"
                                            onclick="showRightModal('{{ route('right_modal', ['view_path' => 'manager.staff.edit', 'user_id' => $active_staff->id]) }}', '{{ __('Edit staff') }}')"
                                        ...
                                        <a href="#" onclick="confirmModal('{{ route('manager.staff.delete', $active_staff->id) }}')" class="btn btn p-0 px-1"
                            ...
                            @foreach ($inactive_staffs as $inactive_staff)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('manager.staff.profile', $inactive_staff->id) }}" class="btn btn p-0 px-1" title="View profile info"
                                            data-bs-toggle="tooltip">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                                                width="15" height="15" x="0" y="0" viewBox="0 0 24 24" style="enable-background:new 0 0 512 512"
                                                xml:space="preserve" class="">
                                        ...
                                        <a class="btn btn p-0 px-1"
                                            onclick="confirmModal('{{ route('manager.staff.status', ['status' => 'active', 'user_id' => $inactive_staff->id]) }}')" href="#"
                                        ...
                                        <a href="#"
                                            onclick="showRightModal('{{ route('right_modal', ['view_path' => 'manager.staff.edit', 'user_id' => $inactive_staff->id]) }}', '{{ __('Edit staff') }}')"
                                            class="btn btn p-0 px-1" title="{{ get_phrase('Edit') }}" data-bs-toggle="tooltip">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                                                width="15" height="15" x="0" y="0" viewBox="0 0 512.001 512.001"
                                                style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                        ...
                                        <a href="#" onclick="confirmModal('{{ route('manager.staff.delete', $inactive_staff->id) }}')" class="btn btn p-0 px-1"
                                            title="{{ get_phrase('Delete') }}" data-bs-toggle="tooltip">
                                            <svg xmlns="http://www.w3.org/2000/svg" id="fi_3405244" data-name="Layer 2" width="15" height="15" viewBox="0 0 24 24">
                                                <path
                                                    d="M19,7a1,1,0,0,0-1,1V19.191A1.92,1.92,0,0,1,15.99,21H8.01A1.92,1.92,0,0,1,6,19.191V8A1,1,0,0,0,4,8V19.191A3.918,3.918,0,0,0,8.01,23h7.98A3.918,3.918,0,0,0,20,19.191V8A1,1,0,0,0,19,7Z">
