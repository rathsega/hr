<h4 class="column-title">
    ...
    <a class="float-end text-primary" href="{{ route('manager.attendance') }}">Back</a>
</h4>
@php
    $attendance = App\Models\Attendance::where('id', $_GET['id'])->first();
@endphp
<form action="{{ route('manager.attendance.update', $_GET['id']) }}" method="post" class="current-location-form">
    @Csrf
    <div class="row">
        <div class="col-md-12">
