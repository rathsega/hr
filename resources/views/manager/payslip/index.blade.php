                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table eTable">
                                ...
                                <tbody>
                                    @php
                                        $payslips = \App\Models\Payslip::where('user_id', auth()->user()->id)
                                            ->whereDate('month_of_salary', '>=', date('Y-1-1 00:00:00', $timestamp))
                                            ->whereDate('month_of_salary', '<=', date('Y-12-31 23:59:59', $timestamp));
