                                                                    ...
                                                                    <td class="text-center position-relative w-80px">
                                                                        ...
                                                                        <div class="contant-overlay">
                                                                            ...
                                                                            @if($leave_report->user_id == auth()->user()->id && in_array($leave_report->status, array('manager_approved', 'hr_approved')))
                                                                                <div class="contant-overlay">
                                                                                    <a href="#" onclick="confirmModal('{{ route('manager.leave.report.cancel', ['id'=>$leave_report->id, 'leave_type'=>$leave_report->leave_type, 'from_date'=>$leave_report->from_date, 'to_date'=>$leave_report->to_date]) }}')" type="button" class="btn px-1 py-0" title="{{ get_phrase('Cancel') }}"
                                                                                        data-bs-toggle="tooltip">
