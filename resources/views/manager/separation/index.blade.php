                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($separation->status != 'Relieved'&& $separation->status != 'Revoked' && $separation->user_id == auth()->user()->id)
                                    <a href="{{ route('manager.separation.revoke', $separation->id) }}" type="button" class="btn px-1 py-0" title="{{ get_phrase('Revoke') }}"
                                        data-bs-toggle="tooltip">
