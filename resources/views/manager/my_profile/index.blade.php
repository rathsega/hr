                ...
                <div class="user-details-info mw-unset">
                    ...
                    <ul class="nav nav-tabs eNav-Tabs-custom" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['info']) }}');" class="nav-link @if ($tab == 'info') active @endif"
                                type="button">
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['task']) }}');" class="nav-link  @if ($tab == 'task') active @endif"
                                type="button">
                                {{get_phrase('Task')}}
                                <span></span>
                            </button>
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['attendance']) }}');"
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['timesheet']) }}');"
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['payslip']) }}');"
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['assessment']) }}');"
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['performance']) }}');"
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['leave']) }}');" class="nav-link @if ($tab == 'leave') active @endif"
                                type="button">
                                {{get_phrase('Leave')}}
                                <span></span>
                            </button>
                        ...
                        <li class="nav-item" role="presentation">
                            <button onclick="redirectTo('{{ route('manager.my.profile', ['inventory']) }}');"
                                class="nav-link @if ($tab == 'inventory') active @endif" type="button">
                    ...
                    <div class="tab-content eNav-Tabs-content" id="myTabContent">
                        <div class="tab-pane fade show active">
                            <div class="eForm-layouts">
                                @include('manager.my_profile.profile_' . $tab)
                            </div>
                        </div>
                    </div>
                </div>
