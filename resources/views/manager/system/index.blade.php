        ...
        <div class="col-md-7 pb-3">
            <div class="eSection-wrap">
                ...
                <div class="eForm-layouts">
                    <form action="{{ route('manager.system.settings.update') }}" method="post">
                        @Csrf
                        <div class="fpb-7">
            ...
            <div class="eSection-wrap pb-3">
                ...
                <div class="row">
                    <div class="col-md-12 pb-4">
                        <div class="card">
                            <div class="card-body">
                                <form class="text-center" action="{{ route('manager.system.logo.update') }}" method="post" enctype="multipart/form-data">
                                    @Csrf
