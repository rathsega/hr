    ...
    <div class="mainSection-title">
        <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
            ...
            <div class="export-btn-area">
                <a href="#" onclick="showRightModal('{{ route('right_modal', ['view_path' => 'manager.branch.add']) }}', '{{ get_phrase('Add new branch') }}')" class="export_btn">
                            ...
                            @foreach (App\Models\Branch::orderBy('title')->get() as $key => $branch)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#"
                                            onclick="showRightModal('{{ route('right_modal', ['view_path' => 'manager.branch.edit', 'id' => $branch->id]) }}', '{{ get_phrase('Edit branch') }}')"
                                            class="btn btn p-0 px-1" title="{{ get_phrase('Edit') }}" data-bs-toggle="tooltip">
                                            <i class="fi-rr-pencil"></i>
                                        </a>

                                        <a href="#" onclick="confirmModal('{{ route('manager.branch.delete', $branch->id) }}')" class="btn btn p-0 px-1"
